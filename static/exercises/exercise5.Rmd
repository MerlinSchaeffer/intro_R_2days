...
2. In which among **all** ESS countries is perceived *racial* discrimination among persons of immigrant origin (i.e., persons born abroad or with at least one parent who was born abroad) most prevalent? `r fitb("France", width = "14")`
...
ESS %>% # Use the ESS, then
  ...
  dplyr::filter( # Keep only respondents of immigrant origin,
    brncntr == "No" | facntr == "No" | mocntr == "No") %>% # then
