...
1) Use the set-up of exercise 6. Drop unused factor levels in `cntry`, and make a design matrix like I did in my slides (i.e., keep only `imwbcnt`, `rlgblg`, `rlgdgr`, `rlgatnd`, `pray`, `cntry`, `par_edu`, `gndr`, `pspwght`, and apply casewise deletion). That design matrix has `r fitb("5305", width = "4")` observations left.
