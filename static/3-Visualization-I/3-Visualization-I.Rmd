...
# Import the ESS round 9 data via the API
ESS_raw <- import_rounds(rounds = 9, ess_email = "merlin.schaeffer@uni-koeln.de", format = "spss")
```
...
ESS <- dplyr::filter(ESS,
                     ...
                     facntr == "Yes" & mocntr == "Yes" &
                       # Only respondents from Germany and land-boarder neighbors:
                       (cntry %in% c("Germany", "Denmark",  "Poland",
                                     "Austria", "Switzerland", "Belgium",
                                     "France", "Czechia", "Netherlands")
))
