...
.alert[Beware, this interpretation only holds if X was (as good as) randomly assigneds!]
]
...
- When Hungary = 0, Slovenia == 0, and Slovakia = 0, then poverty is on average `r round(coef(ols_2)[1], 2)`%.<br> $\rightarrow$ Average xenophobia in Czechia is: `r round(coef(ols_2)[1], 2)`%.

- In Hungary, xenophobia is on average `r round(coef(ols_2)[2], 2)` units lower than among the Czech; and this difference is statistically significant/systematic.
